...
const Cozum = () => {
  ...
  return (
    <div className="px-4">
      <div className="bg-white pt-25.5 rounded-t-3xl  z-20 relative">
        <h2 className=" text-64 text-center font-[font-test-tiempos]">Çözüm Ortaklarımız</h2>
      </div>
          ...
          <div className="2xl:max-w-463.25 max-w-285 2xl:px-57.5 xl:px-10 px-5 mx-auto">
            <div className="flex lg:flex-row flex-col 2xl:justify-between justify-center lg:gap-5 gap-10">
              ...
              <div className='2xl:max-w-143.5 lg:max-w-117.5 lg:pt-12.25'>
                <h2 data-aos="zoom-in" className="mb-5 text-64 font-test-tiempos leading-115 max-lg:text-center">Hakkımızda</h2>
                <h3 data-aos="zoom-in" className="text-accent tracking-[-1.2px] text-xl md:text-2xl leading-140 2xl:text-40 manrope text-dark-yellow font-bold mb-4 md:mb-6  max-lg:text-center">
                ...
                <a href={PAGE_URLS.ABOUT_US} data-aos="fade-up" className="font-manrope font-bold  2xl:text-lg leading-138 text-dark-yellow text-xl manrope flex items-center gap-2.5 w-fit group  transition-all ease-linear duration-300 mb-10 max-lg:text-center max-lg:mx-auto">
                  Devamını Oku
                  <Icons className="group-hover:translate-x-1 transition-all ease-linear duration-300" icon="rightArrow" />
                </a>
                <div className='grid grid-cols-2 '>
                  {STATS_LIST.map((item, index) => (
                    <div
                      ...
                      <h4 data-aos="fade-up" className=" manrope max-lg:text-center max-lg:mx-auto font-bold 2xl:text-32 sm:text-2xl text-xl tracking-[-0.96px] text-dark leading-125 max-w-61.25 relative">
